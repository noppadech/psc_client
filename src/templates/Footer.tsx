...
const Footer = () => {
  return (
    <>
      {/* <!-- Footer Start --> */}
      <div
        className='container-fluid bg-dark text-light wow fadeInUp mt-5'
        data-wow-delay='0.1s'
      >
        <div className='container'>
          <div className='row gx-5'>
            <div className='col-lg-4 col-md-6 footer-about'>
              <div className='d-flex flex-column align-items-center justify-content-center h-100 bg-primary p-4 text-center'>
            ...
            <div className='col-lg-8 col-md-6'>
              <div className='row gx-5'>
                <div className='col-lg-4 col-md-12 mb-5 pt-5'>
                  <div className='section-title section-title-sm position-relative mb-4 pb-3'>
                ...
                <div className='col-lg-4 col-md-12 pt-lg-5 mb-5 pt-0'>
                  <div className='section-title section-title-sm position-relative mb-4 pb-3'>
      ...
      <a
        href='#'
        className='btn btn-lg btn-primary btn-lg-square back-to-top rounded'
      >
